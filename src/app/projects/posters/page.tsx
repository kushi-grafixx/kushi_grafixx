            ...
            <div className="case-study-bg">
                ...
                <section className="cs-text-section">
                    <div className="container cs-content-container">
                        <h1 className="cs-title">Lumi Wellness — Poster Campaign</h1>
                        <div className="cs-body">
                            ...
                            <p>
                                ...
                                remaining restrained, precise, and credible.
                            </p>
                        </div>
                        <div className="cs-tags">
                            {["Posters", "Print Design", "Typography", "Visual Communication"].map(tag => (
