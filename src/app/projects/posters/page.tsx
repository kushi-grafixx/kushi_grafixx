            ...
            <div className="case-study-bg">
                    ...
                    <div className="container container-wide">
                        <div className="cs-hero-image-wrapper">
                            ...
                            <div className="w-full aspect-video bg-white/5 rounded-3xl flex items-center justify-center">
                                <span className="text-white/20 uppercase tracking-widest text-sm font-bold">Poster Series Concept</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="cs-text-section">
                    <div className="container cs-content-container">
                        <h1 className="cs-title">Lumi Wellness Posters</h1>
                        <div className="cs-body">
                            <p>
                                A conceptual series of promotional posters designed for the Lumi Wellness brand.
                                The objective was to strip away the typical chaotic visual noise of the 
                                hospitality sector, replacing it with serene, highly structured compositions.
                            </p>
                            <p>
                                By forcing generous negative space and rigid typographic hierarchies, 
                                each poster acts as a visual palette cleanser, inviting the viewer into 
                                the calm environment of the wellness center itself.
                            </p>
                        </div>
                        <div className="cs-tags">
                            {["Posters and Others", "Hospitality", "Print Design"].map(tag => (
